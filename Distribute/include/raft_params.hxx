...
public:
     ...
     * `LogStore::append`, `LogStore::write_at`, or
     * `LogStore::end_of_append_batch` API triggers asynchronous disk writes
     ...
     * implement `LogStore::last_durable_index` API to return the most recent
